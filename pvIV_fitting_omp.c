...
int main(int argc, char **argv)
{
    ...
    do{
        ...
        {
        case '1':
            Jph0 = genbest[best_gen_number][0];
            Js0 = genbest[best_gen_number][1];
            Rs0 = genbest[best_gen_number][2];
            Rp0 = genbest[best_gen_number][3];
            n0 = genbest[best_gen_number][4];
        ...
        case '2':
            Jph0 = genbest[best_gen_number][0];
            Js10 = genbest[best_gen_number][1];
            Js20 = genbest[best_gen_number][2];
            Rs0 = genbest[best_gen_number][3];
            Rp0 = genbest[best_gen_number][4];
